...
/*
Sistema de controle de uso da passagem, onde espaçonaves com recursos raros, essenciais para sobrevivencia ou 
com individuos necessitando de tratamento tem prioridade;
- Passa pela passagem a espaçonave de maior prioridade
- Toda espaçonave tem um valor de prioridade (int);
- Cada espaçonave tem uma lista de membros e uma lista de recursos;
